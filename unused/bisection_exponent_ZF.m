function [alpha_best,P]=bisection_exponent_ZF(G_veh,m,L,alpha_lims,cond_tol,cvx_tol,bisect_tol)
...
% multiple times.
    ...
    if status        
        ...
        while alpha_lims(2)-alpha_lims(1)>bisect_tol
            ...
            %[status,P]=verify_exp_stab_CC(G_veh,alpha_mid,m,L,dim,cvx_tol);
