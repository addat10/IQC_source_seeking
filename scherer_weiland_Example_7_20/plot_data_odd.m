...
hold on    
plot_scherer_weiland_data_perf(id,'.\data_odd_phi_alpha\mult_flag_causal_6')
plot_scherer_weiland_data_perf(id,'.\data_odd_phi_alpha\mult_flag_anti_causal_6')
plot_scherer_weiland_data_perf(id,'.\data_odd_phi_alpha\mult_flag_non_causal_6')
...
hold on
plot_scherer_weiland_data_stab('.\data_odd_phi_alpha\mult_flag_causal_6')
plot_scherer_weiland_data_stab('.\data_odd_phi_alpha\mult_flag_anti_causal_6')
plot_scherer_weiland_data_stab('.\data_odd_phi_alpha\mult_flag_non_causal_6')
legend('CC','ZFb causal','ZFb anti causal','ZFb non causal')
xlabel('a')
ylabel('b')
