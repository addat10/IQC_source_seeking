...
clc
%% Performance curves
id=5; % represents the fixed value of a
figure()
plot_data_perf(id,'.\data_quadrotor\mult_flag_1')
hold on    
plot_data_perf(id,'.\data_quadrotor\mult_flag_non_causal_6')
% plot_data_perf(id,'.\data_quadrotor\mult_flag_causal_6')
